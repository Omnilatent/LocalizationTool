...
{
    [InitializeOnLoad]
    public class SetupLocalizationTool
    {
        [MenuItem("Tools/Omnilatent/Localization Tool/Import Extra Package")]
        public static void ImportExtraPackage()
        {
            string path = GetPackagePath("Assets/Omnilatent/LocalizationTool/LocalizationToolExtra.unitypackage", "LocalizationToolExtra");
